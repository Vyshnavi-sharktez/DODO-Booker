...
class ServiceAvailabilityAreaDialog extends StatefulWidget {
  const ServiceAvailabilityAreaDialog({super.key, this.existing});

  final ServiceAvailabilityArea? existing;

  @override
  State<ServiceAvailabilityAreaDialog> createState() =>
      _ServiceAvailabilityAreaDialogState();
}

class _ServiceAvailabilityAreaDialogState
    extends State<ServiceAvailabilityAreaDialog> {
  ...
  Future<void> _doSearch(String query) async {
    ...
    try {
      // countrycodes=in restricts to India so suburbs like "KPHB Colony" rank
      // above the parent city when both match the query.
      final results =
  ...
  Future<void> _save() async {
    ...
    final area = ServiceAvailabilityArea(
  ...
  Widget _buildActiveToggle() {
    return Row(
      children: [
        ...
        Text(
          _isActive
              ? 'Active — customers in this area can book'
              : 'Inactive — area is excluded from serviceability checks',
          style: TextStyle(
            fontSize: 13,
