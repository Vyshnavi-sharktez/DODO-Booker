-- ============================================================
-- Per-node flexible content blocks.
--
-- Schema per block (stored as JSONB array):
--   { id, type: 'text'|'image'|'image_text', text?, image_url? }
--
-- Order is preserved by array position.
-- Refreshes catalog_nodes_view and get_catalog_node_children
-- so customer app receives blocks during normal browsing.
-- ============================================================
