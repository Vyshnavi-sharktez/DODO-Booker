-- Update dispatch_booking_next_tier candidate selection query to filter candidates
-- by wallet_minimum_balance and check_vendor_cod_eligibility before selecting the candidate.
