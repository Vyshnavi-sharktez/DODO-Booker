-- Migration: Ensure manual vendor assignment and auto-dispatch engine are completely independent
...
BEGIN
  ...
  -- Abort if booking is already accepted, in_progress, completed, or manually assigned
  ...
  -- Strictly abort if booking was manually assigned or is not in auto-dispatch flow (dispatch_status != 'dispatching')
...
-- Update process_pending_dispatch_escalations to strictly filter for active auto-dispatching bookings
